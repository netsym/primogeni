...
* Ubuntu Linux:
  ...
  4. Set your JAVA\_HOME to the installed openjdk6 (e.g., on 32-bit machine: `set JAVA_HOME=/usr/lib/jvm/java-6-openjdk-i386`)
* Mac OS:
  ...
  4. Set your JAVA_HOME to 


  4. Eclipse (Indigo) and import Slingshot IDE project.(on local machine)
  3. Getting resources from GENI clearinghouse with Primogeni compatible OS images with preinstalled primex and required 
