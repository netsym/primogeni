...
void betweenness(const Graph& g, map<int, float>& degreeBetweenness)
{
    ...
    associative_property_map<VertexBetweenMap>  
	vertexBetweenPropertyMap(vertexBetweenMap);

    brandes_betweenness_centrality(g, 
				   vertexBetweenPropertyMap);
