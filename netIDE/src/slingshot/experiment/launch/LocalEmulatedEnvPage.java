...
import slingshot.environment.configuration.LocalEmulatedConfiguration;
 ...
 */
public class LocalEmulatedEnvPage extends WizardPage implements Listener, EnvPage {
	 ...
	 * @param pageName
	 */
	protected LocalEmulatedEnvPage(String pageName){
		super(pageName);
		setTitle("Local Emulated Environment");
		setDescription("Configure the local emulatedenvironment to run the experiment.");
	}
...
//		}
	...
	public boolean isPageComplete(){
		...
		LocalEmulatedConfiguration e = (LocalEmulatedConfiguration)env.getEnv();
