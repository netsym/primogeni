 ...
 *
 */
public class ExperimentDettachHandler extends ExperimentCommandHandler implements
		IHandler {
	public static final String ID ="experiment.dettach.handler";
	...
	public boolean isEnabled() {
		...
		if(updateCurrentExperiment()) {
			if(curExp.getState() == State.RUNNING_DETACHED) {
				setBaseEnabled(true);
				return true;
			}
		}
