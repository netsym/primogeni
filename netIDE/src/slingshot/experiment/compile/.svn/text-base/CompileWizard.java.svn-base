...
public class CompileWizard extends Wizard implements INewWizard {
	...
	private static final String WIZARD_NAME = "Compile Experiment";	
	...
	protected CompilePage valuesPage;
	...
	public void addPages(){
		super.addPages();
		this.valuesPage = new CompilePage(WIZARD_NAME);
	...
	public boolean performFinish() {
		ipprefix = valuesPage.getIPPrefix();
		return true;
	}
