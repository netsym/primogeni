 ...
 */
public class MyContainerSelectionGroup extends Composite {
	...
	private static final String DEFAULT_MSG_NEW_ALLOWED = "Enter or select the parent project";

	private static final String DEFAULT_MSG_SELECT_ONLY = "Enter or select the parent project";
	 ...
	 */
	public MyContainerSelectionGroup(Composite parent, Listener listener,
	...
	protected void createTreeViewer(int heightHint) {
		...
		MyContainerContentProvider cp = new MyContainerContentProvider();
		//ContainerContentProvider cp = new ContainerContentProvider();
		cp.showClosedProjects(showClosedProjects);
		treeViewer.setContentProvider(cp);
		treeViewer.setLabelProvider(MyWorkbenchLabelProvider
