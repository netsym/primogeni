...
public class MyResourceAndContainerGroup implements Listener {
	// problem identifiers
	...
	// widgets
	private MyContainerSelectionGroup containerGroup;
	 ...
	 *            (file, folder, project)
	 */
	public MyResourceAndContainerGroup(Composite parent, Listener client,
	...
	protected void createContents(Composite parent, String resourceLabelString,
		...
		if (heightHint == SWT.DEFAULT) {
			containerGroup = new MyContainerSelectionGroup(composite, this, true,
