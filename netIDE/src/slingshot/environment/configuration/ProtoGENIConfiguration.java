 ...
 *
 */
public class ProtoGENIConfiguration extends RemoteClusterConfiguration {

	
	
	public ProtoGENIConfiguration(String name, EnvironmentFileModel model) {
		super(name, model);
	}
	 ...
	 */
	public EnvType getType() { return EnvType.PROTO_GENI;}	
}
