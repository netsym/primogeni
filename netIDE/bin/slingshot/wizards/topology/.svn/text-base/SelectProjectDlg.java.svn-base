...
import slingshot.wizards.creation.SlingshotNewProjectWizard;
import slingshot.wizards.widgets.MyContainerSelectionGroup;
...
public class SelectProjectDlg extends SelectionDialog 
{
	class CreateProjectWizard extends SlingshotNewProjectWizard
	{
		CreateProjectWizard()
		{
			super();
     ...
     */
    public SelectProjectDlg(Shell parentShell, IContainer initialRoot,
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        group = new MyContainerSelectionGroup(area, listener,
        ...
        Button createProjectButton = new Button(area, SWT.PUSH);
        createProjectButton.addSelectionListener(new SelectionAdapter() 
        {
        	@Override
        	public void widgetSelected(SelectionEvent e) 
        	{
        	    WizardDialog dialog = new WizardDialog(area.getShell(),
