 ...
 *
 */
public class ShortestPath extends StaticRoutingProtocol {
	/**
	 * Used to load from db
	 */
	public ShortestPath(ModelNodeRecord rec) {
	 ...
	 * @param parent
	 */
	public ShortestPath(INet parent) {
		super(parent,EntityFactory.ShortestPath);
	}
	...
	public IRouteVisitor getRouteVisitor(INet net) {
		return new ShortestPathVisitor(net);
	}
	...
	public StaticRoutingProtocol deepCopy(INet parent) {
		return new ShortestPath(parent);
	}
	
	public IModelNode __copy(String name, IModelNode toCopy, IModelNode parent) {
		return new ShortestPath((INet)parent);
	}
	
	public int getTypeId() {
		return EntityFactory.ShortestPath;
	}
}
