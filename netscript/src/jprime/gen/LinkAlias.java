...
public abstract class LinkAlias extends jprime.ModelNodeAlias implements jprime.gen.ILinkAlias {
	...
	public LinkAlias(IModelNode parent){
		super(parent);
	}
	/**
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		jprime.Link.LinkAliasReplica c = new jprime.Link.LinkAliasReplica(this.getName(),(IModelNode)parent,this);
		return c;
	}
