...
public abstract class FluidQueueAlias extends jprime.NicQueue.NicQueueAlias implements jprime.gen.IFluidQueueAlias {
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		jprime.FluidQueue.FluidQueueAliasReplica c = new jprime.FluidQueue.FluidQueueAliasReplica(this.getName(),(IModelNode)parent,this);
		return c;
	}
