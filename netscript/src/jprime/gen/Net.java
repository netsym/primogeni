...
public abstract class Net extends jprime.ModelNode implements jprime.gen.INet {
	...
	public Net(PyObject[] v, String[] s){super(v,s);}
	public Net(ModelNodeRecord rec){ super(rec); }
	public Net(IModelNode parent){ super(parent); }
	/**
	...
	* @see jprime.IModelNode#getTypeId()
	...
	public jprime.variable.IntegerVariable getIpPrefixLen() {
		return (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.ip_prefix_len());
	}
	...
	public jprime.variable.OpaqueVariable getIpPrefix() {
		return (jprime.variable.OpaqueVariable)getAttributeByName(ModelNodeVariable.ip_prefix());
	}
	...
	public jprime.variable.OpaqueVariable getCnfContentIds() {
		return (jprime.variable.OpaqueVariable)getAttributeByName(ModelNodeVariable.cnf_content_ids());
	}
	...
	public jprime.variable.OpaqueVariable getPortalRules() {
		return (jprime.variable.OpaqueVariable)getAttributeByName(ModelNodeVariable.portal_rules());
	}
	...
	public jprime.variable.IntegerVariable getControllerRid() {
		return (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.controller_rid());
	}
	...
	public jprime.variable.OpaqueVariable getSubEdgeIfaces() {
		return (jprime.variable.OpaqueVariable)getAttributeByName(ModelNodeVariable.sub_edge_ifaces());
	}
