...
public abstract class HTTPServer extends jprime.ApplicationSession.ApplicationSession implements jprime.gen.IHTTPServer {
	...
	public HTTPServer(IModelNode parent){ super(parent); }
	/**
