...
public abstract class NetAliasReplica extends jprime.ModelNodeAliasReplica implements jprime.gen.INetAlias {
	...
	public NetAliasReplica(PyObject[] v, String[] s){super(v,s);}
	/**
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		...
		jprime.Net.NetAliasReplica c = new jprime.Net.NetAliasReplica(this.getName(), (IModelNode)parent,(jprime.Net.NetAlias)this.getReplicatedNode());
