 ...
 *
 */
public class RouteTableAliasReplica extends jprime.gen.RouteTableAliasReplica implements jprime.RouteTable.IRouteTableAlias {
	/**
	 * 
	 */
	public RouteTableAliasReplica(ModelNodeRecord rec){ super(rec); }
	
	public RouteTableAliasReplica(PyObject[] v, String[] n){
		super(v,n);
	}
	...
	* @see jprime.IModelNode#getTypeId()
	 */
	public int getTypeId(){ return jprime.EntityFactory.RouteTableAliasReplica;}
	
	/* (non-Javadoc)
	 * @see jprime.gen.RouteTableAliasReplica#accept(jprime.visitors.IGenericVisitor)
	 */
