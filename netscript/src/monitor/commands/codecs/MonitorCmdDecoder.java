 ...
 *
 */
public class MonitorCmdDecoder extends AbstractCmdDecoder {
    public MonitorCmdDecoder() {
        super(CommandType.MONITOR_CMD);
    }
    @Override
    protected AbstractCmd decodeBody(IoSession session, IoBuffer in, int length) {
    	try {
    		...
    		MonitorCmd rv = new MonitorCmd(cmd, 0, delay, maxRuntime, b==1?true:false);
    		return rv;
