 ...
 * ITable instance and a JTable component.
 */
public class PrefuseTableModel implements TableModel, TableListener {
     ...
     */
    public PrefuseTableModel(ITable table) {
    	m_table = table;
    }
    ...
    /**
     * @see prefuse.data.event.TableListener#tableChanged(prefuse.data.ITable, int, int, int, int)
     */
