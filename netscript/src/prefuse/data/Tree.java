...
public class Tree extends Graph {
     ...
     */
    public Tree(ITable nodes, ITable edges) {
     ...
     * table
     */
    public Tree(ITable nodes, ITable edges, String sourceKey, String targetKey) {
     ...
     * table
     */
    public Tree(ITable nodes, ITable edges, String nodeKey,
    ...
    /**
     * @see prefuse.data.Graph#createLinkITable()
     */
    protected ITable createLinkITable() {
        ITable links = super.createLinkITable();
    ...
    public int getDepth(int node) {
        if ( !getNodeITable().isValidRow(node) )
            return -1;
    ...
    public boolean isValidTree() {
        ...
        // number of parents
        int root = getRootRow();
        IntIterator nodes = getNodeITable().rows();
        while ( nodes.hasNext() ) {
            int n = nodes.nextInt();
