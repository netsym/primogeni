...
public class FunctionTable {
    ...
    private static HashMap s_functionITable;
    static {
        s_functionITable = new HashMap();
        // tuple functions
    ...
    public static boolean hasFunction(String name) {
        return s_functionITable.containsKey(name);
    }
    ...
    public static void addFunction(String name, Class type) {
        ...
        s_functionITable.put(lo, type);
        s_functionITable.put(hi, type);
    }
    ...
    public static Function createFunction(String name) {
        Class type = (Class)s_functionITable.get(name);
        if ( type == null ) {
            throw new IllegalArgumentException(
