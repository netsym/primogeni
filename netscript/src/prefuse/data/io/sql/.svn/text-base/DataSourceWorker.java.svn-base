...
public class DataSourceWorker extends Thread {
    ...
    public static class Entry {
         ...
         * @param table the ITable for storing the results
         ...
         * notifications to be issued before and after query processing. */
        Listener listener;
        /** The ITable for storing the results. */
        ITable  table;
        /** The query to issue. */
        String query;
