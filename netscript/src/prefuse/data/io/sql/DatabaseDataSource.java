 ...
 * the results in prefuse ITable instances. This class should not be
...
public class DatabaseDataSource {
    ...
    /**
     * Executes a query and returns the results in a ITable instance.
     * @param query the text SQL query to execute
     * @return a ITable of the query results
     * @throws DataIOException if an error occurs while executing the query 
     * or adding the query results in a prefuse ITable.
     */
    public synchronized ITable getData(String query) throws DataIOException {
     ...
     * or adding the query results in a prefuse ITable.
     */
    public synchronized ITable getData(String query, String keyField)
    ...
    /**
     * Executes a query and returns the results in a ITable instance.
     * @param t the ITable to store the results in. If this value is null, a
     ...
     * or adding the query results in a prefuse ITable.
     */
    public synchronized ITable getData(ITable t, String query) 
        throws DataIOException
    {
     ...
     * or adding the query results in a prefuse ITable.
     */
    public synchronized ITable getData(ITable t, String query, String keyField) 
        throws DataIOException
    {
     ...
     *  processing. This lock will be synchronized on whenever the ITable is
     *  modified.
     * @return a ITable of the query results
     * @throws DataIOException if an error occurs while executing the query 
     * or adding the query results in a prefuse ITable.
     ...
     * execution.
     * @param t the ITable in which to store the results
     * @param query the query to execute
     */
    public void loadData(ITable t, String query) {
     ...
     */
    public void loadData(ITable t, String query, String keyField) {
     ...
     *  modified.
     */
    public void loadData(ITable t, String query, Object lock) {
     ...
     *  modified.
     */
    public void loadData(ITable t, String query, String keyField, Object lock) {
     ...
     * ITable instance. If a null table is provided, a new table with the
     * appropriate schema will be created.
     * @param t the ITable to store results in
     * @param rset the SQL query result set
     * @return a ITable containing the query results
     */
    protected ITable process(ITable t, ResultSet rset, String key, Object lock)
        throws DataIOException
    {
        // clock in
        int count = 0;
     ...
     * ITable.
     * @param t the prefuse ITable to check for an existing row
     * @param rset the ResultSet, set to a particular row, which may or
     * may not have a matching row in the prefuse ITable
     ...
     * @throws SQLException
     */
    protected int getExistingRow(ITable t, ResultSet rset, String keyField)
        throws SQLException
    {
