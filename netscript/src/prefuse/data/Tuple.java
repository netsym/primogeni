...
public interface Tuple {
    ...
    /**
     * Returns the ITable instance that backs this Tuple, if it exists.
     * @return the backing ITable, or null if there is none.
     */
    public ITable getTable();
    
    /**
     * Returns the row index for this Tuple's backing ITable, if it exists.
