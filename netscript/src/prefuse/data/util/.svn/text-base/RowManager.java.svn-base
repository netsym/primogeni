...
/**
 * Manages the set of valid rows for a ITable instance, maintains an index of
...
public class RowManager {
    ...
    /**
     * Create a new RowManager for the given ITable.
     * @param table the ITable to manage
     */
    public RowManager(ITable table) {
        m_table = table;
    }
     ...
     * @return true if the row is valid and in use by the ITable, false if
    ...
    /**
     * Given ITable row and column indices, return the corresponding row in
     ...
     * @param col the table column
     * @return the row value for the ITable that corresponds to the
     * given column row
     */
