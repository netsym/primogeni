 ...
 * instance. They are created automatically by ITable instances and are
 * retrieved using the {@link prefuse.data.ITable#getMetadata(String)} method.
...
public class ColumnMetadata implements ColumnListener {
     ...
     */
    public ColumnMetadata(ITable table, String column) {
