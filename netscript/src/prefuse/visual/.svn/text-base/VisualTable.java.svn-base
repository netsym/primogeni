...
/**
 * A visual abstraction of a ITable data structure. Serves as a backing table
 ...
 * {@link Visualization#addITable(String, ITable)} method.
 * 
...
public class VisualTable extends CascadedTable implements VisualTupleSet {
     ...
     */
    public VisualTable(ITable parent, Visualization vis, String group) {
