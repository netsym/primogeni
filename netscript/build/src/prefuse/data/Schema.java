...
/**
 * <p>The Schema class represents a description of a ITable's columns, including
 * column names, data types, and default values. New ITable
...
public class Schema implements Cloneable {
    ...
    /**
     * Instantiate this schema as a new ITable instance.
     * @return a new ITable with this schema
     */
    public ITable instantiate() {
     ...
     * @return a new ITable with this schema
     */
    public ITable instantiate(int nrows) {
        ITable t = new Table(nrows, m_size);
        for ( int i=0; i<m_size; ++i ) {
