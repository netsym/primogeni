...
public class IOLib {
    ...
    /**
     * Present a file chooser dialog for loading a ITable data set.
     * @param c user interface component from which the request is being made
     * @return a newly loaded ITable, or null if not found or action canceled
     */
    public static ITable getTableFile(Component c) {
        JFileChooser jfc = new JFileChooser();
        jfc.setDialogType(JFileChooser.OPEN_DIALOG);
        jfc.setDialogTitle("Open ITable File");
        ...
        try {
            return tr.readITable(streamFromString(f.getAbsolutePath()));
        } catch ( Exception e ) {
