...
/**
 * Swing component that displays a prefuse ITable instance in a Swing
 * JTable component.
 * 
...
public class JPrefuseTable extends JTable {
     ...
     * @param t the ITable to display.
     */
    public JPrefuseTable(ITable t) {
        super();
        m_table = t;
     ...
     * @return a prefuse ITable instance
     */
    ...
    /**
     * Create a new window displaying the contents of the input ITable as
     * a Swing JTable.
     * @param t the ITable instance to display
     * @return a reference to the JFrame holding the table view
     */
    public static JFrame showITableWindow(ITable t) {
