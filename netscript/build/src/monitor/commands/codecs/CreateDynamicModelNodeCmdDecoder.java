 ...
 *
 */
public class CreateDynamicModelNodeCmdDecoder extends AbstractCmdDecoder {
    public CreateDynamicModelNodeCmdDecoder() {
        super(CommandType.CREATE_DYNAMIC_MODEL_NODE);
    }
    @Override
    protected AbstractCmd decodeBody(IoSession session, IoBuffer in, int length) {
    	try {
    		return new CreateDynamicModelNode(in.getInt(),in.getString(in.getInt(),csd));
