 ...
 *
 */
public class LocalController  extends Thread implements IController, IPrimeStateListener{
	 ...
	 * @param tlv
	 */
	public LocalController(Experiment exp, PartTlvPair parting, int runtime, int procs, double emuRatio, IExpListenter l, String primexDir, boolean visualize, Map<String,String> runtimeSymbols, String directory) {
		this.exp = exp;
	...
	public void run() {
		...
		try {
			running = true;
			listener.println("Starting exp by LocalController!");
