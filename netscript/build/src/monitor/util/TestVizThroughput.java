 ...
 * 
 */
public class TestVizThroughput {
	...
	public static void main(String[] args) throws IOException {
		if(args.length!=5) {
			System.err.println("Usage: java [properties] monitor.util.TestVizThroughput <model name> <model file> <time> <master> <slave>");
			System.exit(0);
		}
	...
	private static final class TPListener extends Thread implements IExpListenter {
		...
		public TPListener(long[] aoi, int runtime) {
			super();
			this.aoi = aoi;
	...
	private static void run(PartTlvPair parting, long[] aoi,ComputeNode master,ArrayList<ComputeNode> slaves, int runtime) {
		TPListener l = new TPListener(aoi,runtime);
