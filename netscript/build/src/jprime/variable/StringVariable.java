 ...
 */
public class StringVariable extends ModelNodeVariable implements Serializable {
	private static final long serialVersionUID = -4780126541081367344L;
	...
	/* $if SEPARATE_PROP_TABLE $
	public StringVariable(Metadata meta, long dbid, long db_owner_id, int db_type, int db_name, String value) {
		super(meta,dbid,db_owner_id,EntityFactory.StringVariable, db_name,value);
	}
	$else$ */
	public StringVariable(ModelNode owner, int db_name, String value) {
		super(owner,db_name);
		this.value=value;
	}
	/* $endif$ */
	...
	/* $if SEPARATE_PROP_TABLE $
	public StringVariable(int db_name, String value) {
    ...
    public boolean equals(Object obj) {
    	return (obj instanceof StringVariable && value.equals(((StringVariable)obj).value));
    }
	...
	public static int getClassTypeId() {
		return EntityFactory.StringVariable;
	}
	...
	public String encodeTLV() {
		...
		attr+= TLVVisitor.makeTLV(TLVType.STRING,value.length(),value);
