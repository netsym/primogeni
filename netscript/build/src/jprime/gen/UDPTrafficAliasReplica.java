...
public abstract class UDPTrafficAliasReplica extends jprime.StaticTrafficType.StaticTrafficTypeAliasReplica implements jprime.gen.IUDPTrafficAlias {
	public UDPTrafficAliasReplica(String name, IModelNode parent, jprime.ModelNodeAlias referencedNode) {
		super(name, parent,referencedNode);
	}
	public UDPTrafficAliasReplica(ModelNodeRecord rec){ super(rec); }
	public UDPTrafficAliasReplica(PyObject[] v, String[] s){super(v,s);}
	/**
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		...
		jprime.UDPTraffic.UDPTrafficAliasReplica c = new jprime.UDPTraffic.UDPTrafficAliasReplica(this.getName(), (IModelNode)parent,(jprime.UDPTraffic.UDPTrafficAlias)this.getReplicatedNode());
