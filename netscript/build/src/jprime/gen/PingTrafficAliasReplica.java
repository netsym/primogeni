...
public abstract class PingTrafficAliasReplica extends jprime.ICMPTraffic.ICMPTrafficAliasReplica implements jprime.gen.IPingTrafficAlias {
	public PingTrafficAliasReplica(String name, IModelNode parent, jprime.ModelNodeAlias referencedNode) {
		super(name, parent,referencedNode);
	}
	public PingTrafficAliasReplica(ModelNodeRecord rec){ super(rec); }
	public PingTrafficAliasReplica(PyObject[] v, String[] s){super(v,s);}
	/**
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		...
		jprime.PingTraffic.PingTrafficAliasReplica c = new jprime.PingTraffic.PingTrafficAliasReplica(this.getName(), (IModelNode)parent,(jprime.PingTraffic.PingTrafficAlias)this.getReplicatedNode());
