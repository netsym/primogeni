...
public abstract class Host extends jprime.ProtocolGraph.ProtocolGraph implements jprime.gen.IHost {
	...
	public Host(PyObject[] v, String[] s){super(v,s);}
	public Host(ModelNodeRecord rec){ super(rec); }
	public Host(IModelNode parent){ super(parent); }
	/**
	...
	* @see jprime.IModelNode#getTypeId()
	...
	public jprime.variable.IntegerVariable getHostSeed() {
		return (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.host_seed());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getTimeSkew() {
		return (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.time_skew());
	}
	...
	public jprime.variable.OpaqueVariable getTimeOffset() {
		return (jprime.variable.OpaqueVariable)getAttributeByName(ModelNodeVariable.time_offset());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getTrafficIntensity() {
		return (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.traffic_intensity());
	}
