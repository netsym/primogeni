...
public abstract class HostAliasReplica extends jprime.ProtocolGraph.ProtocolGraphAliasReplica implements jprime.gen.IHostAlias {
	public HostAliasReplica(String name, IModelNode parent, jprime.ModelNodeAlias referencedNode) {
		super(name, parent,referencedNode);
	}
	public HostAliasReplica(ModelNodeRecord rec){ super(rec); }
	public HostAliasReplica(PyObject[] v, String[] s){super(v,s);}
	/**
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		...
		jprime.Host.HostAliasReplica c = new jprime.Host.HostAliasReplica(this.getName(), (IModelNode)parent,(jprime.Host.HostAlias)this.getReplicatedNode());
