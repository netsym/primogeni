...
public abstract class Link extends jprime.ModelNode implements jprime.gen.ILink {
	...
	public Link(ModelNodeRecord rec){ super(rec); }
	public Link(IModelNode parent){ super(parent); }
	/**
	...
	* @see jprime.IModelNode#getTypeId()
	...
	public jprime.variable.FloatingPointNumberVariable getDelay() {
		return (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.delay());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getBandwidth() {
		return (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.bandwidth());
	}
