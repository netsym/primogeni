...
public abstract class RedQueueAlias extends jprime.NicQueue.NicQueueAlias implements jprime.gen.IRedQueueAlias {
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		jprime.RedQueue.RedQueueAliasReplica c = new jprime.RedQueue.RedQueueAliasReplica(this.getName(),(IModelNode)parent,this);
		return c;
	}
