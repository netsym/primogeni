...
public abstract class STCPMaster extends jprime.ProtocolSession.ProtocolSession implements jprime.gen.ISTCPMaster {
	...
	public STCPMaster(PyObject[] v, String[] s){super(v,s);}
	public STCPMaster(ModelNodeRecord rec){ super(rec); }
	public STCPMaster(IModelNode parent){ super(parent); }
	/**
