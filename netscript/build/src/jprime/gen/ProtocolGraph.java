...
public abstract class ProtocolGraph extends jprime.ModelNode implements jprime.gen.IProtocolGraph {
	...
	public ProtocolGraph(IModelNode parent){ super(parent); }
	/**
	...
	public static boolean isSubType(int id) {
		switch(id) {
			case 1031: //ProtocolGraph
			case 1032: //Host
			case 1033: //Router
			case 1087: //ProtocolGraphAlias
			case 1088: //HostAlias
	...
	* @see jprime.IModelNode#getTypeId()
	...
	public jprime.variable.BooleanVariable getAutomaticProtocolSessionCreation() {
		return (jprime.variable.BooleanVariable)getAttributeByName(ModelNodeVariable.automatic_protocol_session_creation());
	}
