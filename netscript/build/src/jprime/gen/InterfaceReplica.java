...
public abstract class InterfaceReplica extends jprime.BaseInterface.BaseInterfaceReplica implements jprime.gen.IInterface {
	...
	public InterfaceReplica(ModelNodeRecord rec){ super(rec); }
	public InterfaceReplica(PyObject[] v, String[] s){super(v,s);}
	/**
	...
	* @see jprime.IModelNode#getTypeId()
	...
	public jprime.variable.FloatingPointNumberVariable getBitRate() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.bit_rate());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.bit_rate());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getLatency() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.latency());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.latency());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getJitterRange() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.jitter_range());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.jitter_range());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getDropProbability() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.drop_probability());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.drop_probability());
	}
	...
	public jprime.variable.IntegerVariable getBufferSize() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.buffer_size());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.buffer_size());
	}
	...
	public jprime.variable.IntegerVariable getMtu() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.mtu());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.mtu());
	}
	...
	public jprime.variable.BooleanVariable getIsOn() {
		jprime.variable.BooleanVariable temp = (jprime.variable.BooleanVariable)getAttributeByName(ModelNodeVariable.is_on());
		if(null!=temp) return temp;
		return (jprime.variable.BooleanVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.is_on());
	}
	...
	public jprime.variable.IntegerVariable getNumInPackets() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_in_packets());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_in_packets());
	}
	...
	public jprime.variable.IntegerVariable getNumInBytes() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_in_bytes());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_in_bytes());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getPacketsInPerSec() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.packets_in_per_sec());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.packets_in_per_sec());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getBytesInPerSec() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.bytes_in_per_sec());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.bytes_in_per_sec());
	}
	...
	public jprime.variable.IntegerVariable getNumInUcastPackets() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_in_ucast_packets());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_in_ucast_packets());
	}
	...
	public jprime.variable.IntegerVariable getNumInUcastBytes() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_in_ucast_bytes());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_in_ucast_bytes());
	}
	...
	public jprime.variable.IntegerVariable getNumOutPackets() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_out_packets());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_out_packets());
	}
	...
	public jprime.variable.IntegerVariable getNumOutBytes() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_out_bytes());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_out_bytes());
	}
	...
	public jprime.variable.IntegerVariable getNumOutUcastPackets() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_out_ucast_packets());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_out_ucast_packets());
	}
	...
	public jprime.variable.IntegerVariable getNumOutUcastBytes() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.num_out_ucast_bytes());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.num_out_ucast_bytes());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getPacketsOutPerSec() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.packets_out_per_sec());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.packets_out_per_sec());
	}
	...
	public jprime.variable.FloatingPointNumberVariable getBytesOutPerSec() {
		jprime.variable.FloatingPointNumberVariable temp = (jprime.variable.FloatingPointNumberVariable)getAttributeByName(ModelNodeVariable.bytes_out_per_sec());
		if(null!=temp) return temp;
		return (jprime.variable.FloatingPointNumberVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.bytes_out_per_sec());
	}
	...
	public jprime.variable.IntegerVariable getQueueSize() {
		jprime.variable.IntegerVariable temp = (jprime.variable.IntegerVariable)getAttributeByName(ModelNodeVariable.queue_size());
		if(null!=temp) return temp;
		return (jprime.variable.IntegerVariable)this.getReplicatedNode().getAttributeByName(ModelNodeVariable.queue_size());
	}
