...
public abstract class InterfaceAliasReplica extends jprime.BaseInterface.BaseInterfaceAliasReplica implements jprime.gen.IInterfaceAlias {
	public InterfaceAliasReplica(String name, IModelNode parent, jprime.ModelNodeAlias referencedNode) {
		super(name, parent,referencedNode);
	}
	public InterfaceAliasReplica(ModelNodeRecord rec){ super(rec); }
	public InterfaceAliasReplica(PyObject[] v, String[] s){super(v,s);}
	/**
	...
	public jprime.ModelNode deepCopy(jprime.ModelNode parent) {
		...
		jprime.Interface.InterfaceAliasReplica c = new jprime.Interface.InterfaceAliasReplica(this.getName(), (IModelNode)parent,(jprime.Interface.InterfaceAlias)this.getReplicatedNode());
