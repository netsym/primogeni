 ...
 */
public class CampusPortal extends ModelInterface{

	/**
	 * @param db
	 * @param exp
	 */
	public CampusPortal(Database db, Experiment exp) {
	 ...
	 * @param expName
	 */
	public CampusPortal(Database db, String expName) {
	...
	public INet buildModel(Map<String, ModelParamValue> parameters) {
		...
		IInterface net1_r1_if2 = net1_r1.createInterface("p10_1_2_0");
		...
		//XXX
		//we are replacing host 5 with a traffic portal to an external net
		...
		//net1_r1_h5.setDelay((float)0.0001);
		...
		IInterface net2_r5_if1 = net2_r5.createInterface("p10_1_5_0"); //connects to the lan
		...
		ILink net2_lan0_r2 = net2.createLink("lna0_r2");
		...
		//XXX do we want any simulated traffic?
		//ITraffic t = top.createTraffic();
		
		//setup the traffic portals
		left_portal.createTrafficPortal();//XXX
		left_portal.setIpAddress("10.1.5.3");
		left_portal.addReachableNetwork("10.1.3.0/24");
		
		right_portal.createTrafficPortal();//XXX		
		right_portal.setIpAddress("10.1.2.2");
		right_portal.addReachableNetwork("10.1.2.0/24");
