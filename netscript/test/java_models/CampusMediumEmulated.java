 ...
 */
public class CampusMediumEmulated extends ModelInterface{

	/**
	 * @param db
	 * @param exp
	 */
	public CampusMediumEmulated(Database db, Experiment exp) {
	 ...
	 * @param expName
	 */
	public CampusMediumEmulated(Database db, String expName) {
	...
	public INet buildModel(Map<String, ModelParamValue> parameters) {
		...
		//Creating Emualted hosts
		

		
		
		//topnet:net3:lan1:h[31].enableEmulation();
		//topnet:net2:lan0:h[17].enableEmulation();
		net1_h3.enableEmulation();
		net1_h5.enableEmulation();
		net1_h4.enableEmulation();
		...
		p.setCount(1);
		//p.setSrcs("[606]");//topnet:net2:lan0:h1
		p.setSrcs("{topnet:net2:lan0:h1}");
		//p.setDsts("[178]"); //topnet:net01:net1:h2
		p.setDsts("{topnet:net01:net1:h2}");
		//p.setDsts("[8106]"); //topnet:net3:lan0:h1
		
		
		//add emulated traffic
		//IHost em_net1_h3 = (IHost)net1_h3.get("h3");
		//IHost em_net1_h5 = (IHost)net1_h5.get("h5");
