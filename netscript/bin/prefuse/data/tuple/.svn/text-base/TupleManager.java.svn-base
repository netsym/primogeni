...
public class TupleManager {
    ...
    /**
     * Create a new TupleManager for the given ITable.
     * @param t the data ITable to generate Tuples for
     */
    public TupleManager(ITable t, Graph g, Class tupleType) {
        init(t, g, tupleType);
    }
    
    /**
     * Initialize this TupleManager for use with a given ITable.
     * @param t the data ITable to generate Tuples for
     */
    public void init(ITable t, Graph g, Class tupleType) {
        if ( m_table != null ) {
