 ...
 * a Java data value for use in a prefuse ITable.
 * 
...
public interface SQLDataHandler {
     ...
     * Java data value and storing it in a ITable.
     * @param t the ITable in which to store the result value
     * @param trow the ITable row to add to
     ...
     * to access the correct data field of the ITable.
     * @throws SQLException if an error occurs accessing the ResultSet
     */
    public void process(ITable t, int trow, ResultSet rset, int rcol)
        throws SQLException;
