...
/**
 * <p>ITable subclass featuring a "cascaded" table design - a CascadedTable can
 ...
 * 
 * <p>ITable rows of the parent table can be selectively included by providing
...
public class CascadedTable extends Table {
     ...
     * @param parent the parent ITable to use
     */
    public CascadedTable(ITable parent) {
     ...
     */
    public CascadedTable(ITable parent, Predicate rowFilter) {
     ...
     */
    public CascadedTable(ITable parent, ColumnProjection colFilter) {
     ...
     */
    protected CascadedTable(ITable parent, Predicate rowFilter, 
    ...
    /**
     * @see prefuse.data.ITable#hasColumn(java.lang.String)
     */
    ...
    /**
     * @see prefuse.data.ITable#getColumnNames()
     */
