 ...
 *
 */
public class HostAlias extends jprime.gen.HostAlias implements
		jprime.Host.IHostAlias {
	/**
	 * @param v
	 * @param n
	 */
	public HostAlias(PyObject[] v, String[] n){super(v,n);}

	/**
	 * 
	 */
	public HostAlias(ModelNodeRecord rec) {
		super(rec);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see jprime.gen.HostAlias#accept(jprime.visitors.IGenericVisitor)
	 */
