 ...
 *
 */
public class NetAlias extends jprime.gen.NetAlias implements jprime.Net.INetAlias {
	/**
	 * @param v
	 * @param n
	 */
	public NetAlias(PyObject[] v, String[] n){super(v,n);}
	
	public NetAlias(IModelNode parent){ super(parent); }
	...
	public NetAlias(IModelNode parent, jprime.Net.INet referencedNode) {
		super(parent,(jprime.Net.INet)referencedNode);
	}

	/* (non-Javadoc)
	* @see jprime.IModelNode#getTypeId()
	 */
	public int getTypeId(){ return jprime.EntityFactory.NetAlias;}
	
	/* (non-Javadoc)
	 * @see jprime.gen.NetAlias#accept(jprime.visitors.IGenericVisitor)
	 */
	...
	public IRoutingSphere getRoutingSphere() {
		return ((INet)deference()).getRoutingSphere();
	}
	...
	public boolean isRoutingSphere() {
		return ((INet)deference()).getStaticRoutingProtocol()!=null;
	}
