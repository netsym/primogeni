 ...
 */
public class AlignedUIDRange extends IUIDRange {
	protected Alignment alignment;
	protected long low;
	protected long high;
		
	public AlignedUIDRange(long low, long high, Alignment alignment){
		super();
	...
	public AlignedUIDRange(UIDRange uid, Alignment alignment){
		super();
		this.alignment=alignment;
		this.low=uid.low;
		this.high=uid.high;
