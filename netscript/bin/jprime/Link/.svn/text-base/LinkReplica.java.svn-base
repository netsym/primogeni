 ...
 *
 */
public class LinkReplica extends jprime.gen.LinkReplica implements jprime.Link.ILink {
	 ...
	 * 
	 */
	public LinkReplica(ModelNodeRecord rec){
		super(rec);
		alignments=null;
	}
	...
	public LinkReplica(String name, IModelNode parent, jprime.Link.ILink referencedNode) {
		super(name, parent,(jprime.Link.ILink)referencedNode);
		alignments=null;
	}
	...
	* @see jprime.IModelNode#getTypeId()
	 */
	public int getTypeId(){ return jprime.EntityFactory.LinkReplica; }
	
	/* (non-Javadoc)
	 * @see jprime.gen.LinkReplica#accept(jprime.visitors.IGenericVisitor)
	 */
