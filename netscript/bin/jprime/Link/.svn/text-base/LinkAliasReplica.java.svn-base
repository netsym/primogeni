 ...
 *
 */
public class LinkAliasReplica extends jprime.gen.LinkAliasReplica implements jprime.Link.ILinkAlias {
	...
	* @see jprime.IModelNode#getTypeId()
	 */
	public int getTypeId(){ return jprime.EntityFactory.LinkAliasReplica; }

	/* (non-Javadoc)
	 * @see jprime.gen.LinkAliasReplica#accept(jprime.visitors.IGenericVisitor)
	 */
