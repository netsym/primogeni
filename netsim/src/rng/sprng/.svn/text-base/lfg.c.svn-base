...
#ifdef __STDC__
inline /*static*/ int get_llag_rng(void)
#else
inline /*static*/ int get_llag_rng()
#endif
{
        return(lval);
}
...
#ifdef __STDC__
inline /*static*/ int get_klag_rng(void)
#else
inline /*static*/ int get_klag_rng()
#endif
{
        return(kval);
}
...
#ifdef __STDC__
inline /*static*/ int get_seed_rng(int *gen)
#else
inline /*static*/ int get_seed_rng(gen)
int *gen;
#endif
{
        return(GS0^gseed);
...
#ifdef __STDC__
inline /*static*/ int get_hptr_rng( int *genptr)
#else
inline /*static*/ int get_hptr_rng(genptr)
int *genptr;
#endif
{
...
#ifdef __STDC__
inline /*static*/ int *get_fill_rng( int *genptr)
#else
inline /*static*/ int *get_fill_rng(genptr)
int *genptr;
#endif
{
  int i,*p;
...
#ifdef __STDC__
inline /*static*/ int *get_next_index_rng( int *genptr)
#else
inline /*static*/ int *get_next_index_rng(genptr)
int *genptr;
#endif
{
  int i,*p, lval;
...
#ifdef __STDC__
inline /*static*/ void si_halve(int *a, int length)
#else
inline /*static*/ void si_halve(a, length)
int *a, length;
#endif
{
  int i;
...
#ifdef __STDC__
inline /*static*/ int *get_node_index_rng( int *genptr)
#else
inline /*static*/ int *get_node_index_rng(genptr)
int *genptr;
#endif
{
  int *p, length;
