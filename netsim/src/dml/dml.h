...
namespace dml {
  ...
  public:
     ...
     */
    Configuration() : DNA(Configuration::DML_CONFIGURATION_DNA) {}
    ...
    Configuration(const Configuration& cfg) :
      DNA(Configuration::DML_CONFIGURATION_DNA) {}
     ...
     */
    virtual void* findSingle(const char* spec) = 0;
     ...
     * findSingle() method.
     */
    virtual Enumeration* find(const char* spec) = 0;
   ...
   * prime::dml::Configuration::isConf() method, which is used to test
   * whether a DML attribute value (returned by
   * prime::dml::Configuration::findSingle() or
   * prime::dml::Configuration::find() method) is a singleton or
   * another list of attributes (as of a Configuration object).
   */
#define DML_ISCONF(x) prime::dml::Configuration::isConf(x)
  ...
  public:
     ...
     */
    virtual void* findSingle(const char* spec);
     ...
     * \sa Configuration::find().
     */
    virtual Enumeration* find(const char* spec);
