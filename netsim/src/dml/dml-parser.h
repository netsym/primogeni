...
typedef class prime::dml::dmlConfig* PRIME_DML_SYM_DMLCONFIG;
typedef class prime::dml::AttrKey*   PRIME_DML_SYM_ATTRKEY;
typedef class prime::dml::LocInfo*   PRIME_DML_SYM_LOCINFO;
typedef class prime::dml::KeyValue*  PRIME_DML_SYM_KEYVALUE;
