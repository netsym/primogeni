...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_PROPERTY_DECL(int, traffic_type_seed)
	)
	SSFNET_STATEMAP_DECL(
		SSFNET_CONFIG_STATE_DECL(CommunityIDList, community_ids)
...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_PROPERTY_DECL(ResourceIdentifier, srcs)
		SSFNET_CONFIG_PROPERTY_DECL(ResourceIdentifier, dsts)
		SSFNET_CONFIG_PROPERTY_DECL(DstIPVec, dst_ips)
		SSFNET_CONFIG_PROPERTY_DECL(float, start_time)
		SSFNET_CONFIG_PROPERTY_DECL(float, interval)
		SSFNET_CONFIG_PROPERTY_DECL(bool, interval_exponential)
		SSFNET_CONFIG_PROPERTY_DECL(SSFNET_STRING, mapping)
	)
	SSFNET_STATEMAP_DECL(
		int mapping;
...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_CHILDREN_DECL_SHARED(TrafficType, traffic_types)
	)
	SSFNET_STATEMAP_DECL(
		SSFNET_CONFIG_CHILDREN_DECL_UNSHARED(Traffic,TrafficType,traffic_types)
	)
	SSFNET_CONFIG_CHILDREN_DECL(TrafficType, traffic_types)
	SSFNET_ENTITY_SETUP(&(unshared.traffic_types) )
;
