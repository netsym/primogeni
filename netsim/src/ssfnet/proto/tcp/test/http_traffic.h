...
public:
	SSFNET_PROPMAP_DECL(
		...
		SSFNET_CONFIG_PROPERTY_DECL(uint64_t, file_size)
		SSFNET_CONFIG_PROPERTY_DECL(bool, file_pareto)
		SSFNET_CONFIG_PROPERTY_DECL(bool, to_emulated)
		SSFNET_CONFIG_PROPERTY_DECL(uint32_t, number_of_sessions)
		SSFNET_CONFIG_PROPERTY_DECL(uint32_t, connections_per_session)
