...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_PROPERTY_DECL(SSFNET_STRING, protocol_type)
		SSFNET_CONFIG_PROPERTY_DECL(ResourceIdentifier, srcs)
		SSFNET_CONFIG_PROPERTY_DECL(ResourceIdentifier, dsts)
		SSFNET_CONFIG_PROPERTY_DECL(float, off_time)
		SSFNET_CONFIG_PROPERTY_DECL(SSFNET_STRING, mapping)
		SSFNET_CONFIG_PROPERTY_DECL(int, nflows)
		SSFNET_CONFIG_PROPERTY_DECL(float, pktsiz)
		SSFNET_CONFIG_PROPERTY_DECL(float, hurst)
		SSFNET_CONFIG_PROPERTY_DECL(float, md)
		SSFNET_CONFIG_PROPERTY_DECL(float, wndmax)
		SSFNET_CONFIG_PROPERTY_DECL(float, sendrate)
		SSFNET_CONFIG_PROPERTY_DECL(float, start)
		SSFNET_CONFIG_PROPERTY_DECL(float, stop)
	)
	SSFNET_STATEMAP_DECL(
		SSFNET_CONFIG_STATE_DECL(SSFNET_STRING, monfn)
		SSFNET_CONFIG_STATE_DECL(float, monres)
		int protocol_type;
		float pktsiz;
		float sendrate;
		float wndmax;
