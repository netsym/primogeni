...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_PROPERTY_DECL(uint32_t, listening_port)
	)
	SSFNET_STATEMAP_DECL(
		SSFNET_CONFIG_STATE_DECL(uint32_t, bytes_received)
		SSFNET_CONFIG_STATE_DECL(uint32_t, bytes_sent)
		SSFNET_CONFIG_STATE_DECL(uint32_t, requests_received)
		SSFNET_CONFIG_STATE_DECL(CNFContentMap, cnf_content_sizes)
	)
	SSFNET_ENTITY_SETUP( )
;
...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_PROPERTY_DECL(UIDVec, cnf_routers)
		SSFNET_CONFIG_PROPERTY_DECL(bool, is_controller)
	)
	SSFNET_STATEMAP_DECL(
		SSFNET_CONFIG_STATE_DECL(uint32_t, bytes_received)
		SSFNET_CONFIG_STATE_DECL(uint32_t, requests_received)
