...
public:
	SSFNET_PROPMAP_DECL(
		SSFNET_CONFIG_PROPERTY_DECL(UID_t, dst_port)
		SSFNET_CONFIG_PROPERTY_DECL(int, content_id)
		SSFNET_CONFIG_PROPERTY_DECL(int, number_of_contents)
		SSFNET_CONFIG_PROPERTY_DECL(int, number_of_requests)
	)
