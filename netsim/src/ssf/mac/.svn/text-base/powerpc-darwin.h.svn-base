/*
 * powerpc-darwin :- support for Mac OS on PowerPC processors.
 */

#ifdef PRIME_SSF_ARCH_POWERPC_DARWIN

#ifndef __PRIME_SSF_MACHINE_POWERPC_DARWIN_H__
#define __PRIME_SSF_MACHINE_POWERPC_DARWIN_H__

#ifndef __PRIME_SSF_MACHINES_H__
#error "ERROR: powerpc-darwin.h must not be included explicitly"
#endif

#include <stdio.h>

/* Here we use pthreads for multiprocessing. In this case, both data
   and heap should be shared. We intentionally put heap segment as
   private so that our shared memory manager (arena) will kick in for
...
#endif /*__PRIME_SSF_MACHINE_POWERPC_DARWIN_H__*/

#endif /*PRIME_SSF_ARCH_POWERPC_DARWIN*/
