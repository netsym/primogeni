...
#ifndef __PRIME_SSF_MACHINE_POWERPC_AIX_H__
#define __PRIME_SSF_MACHINE_POWERPC_AIX_H__

#ifndef __PRIME_SSF_MACHINES_H__
#error "ERROR: powerpc-aix.h must not be included explicitly"
#endif
...
#endif /*__PRIME_SSF_MACHINE_POWERPC_AIX_H__*/
