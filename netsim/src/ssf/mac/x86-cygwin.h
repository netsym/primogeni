...
#ifndef __PRIME_SSF_MACHINE_X86_CYGWIN_H__
#define __PRIME_SSF_MACHINE_X86_CYGWIN_H__

#ifndef __PRIME_SSF_MACHINES_H__
#error "ERROR: x86-cygwin.h must not be included explicitly"
#endif
...
#endif /*__PRIME_SSF_MACHINE_X86_CYGWIN_H__*/
